...
if __name__ == "__main__":
    demo = gr.ChatInterface(
        ...
        title="Personal Diet Tracker Assistant",
        description="This assistant helps you track your meals, analyze food images, calculate calories and nutrition, and answer dietary questions.",
        type="messages",
        multimodal=True,
