...
class Settings(BaseSettings):
    ...
    Attributes:
        ...
        STORAGE_BUCKET_NAME: Name of the Google Cloud Storage bucket for storing meal images.
        DB_COLLECTION_NAME: Name of the Firestore collection for storing meal/nutrition data.
    """

    GCLOUD_LOCATION: str
    GCLOUD_PROJECT_ID: str
    BACKEND_URL: str = "http://localhost:8081/chat"
    STORAGE_BUCKET_NAME: str = "personal-diet-tracker-meals"
    DB_COLLECTION_NAME: str = "personal-diet-tracker-meals"
